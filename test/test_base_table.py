...
def test_update_or_create():
    ...
    # first create
    tt.update_or_create(by_key='col_1', by_value=333, new_values={'col_1':333, 'col_2': 444})

    assert tt.len() == 3
    # now upodates
    tt.update_or_create(by_key='col_1', by_value=333, new_values={'col_1':444, 'col_2': 555})
    assert tt.len() == 3
