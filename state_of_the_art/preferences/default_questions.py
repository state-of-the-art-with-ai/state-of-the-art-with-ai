...
Define them well with examples do not assume the reader knows them. Use contrastive examples to make the definitions clear""",
    "top_insights": """What are the most relevant learnings of the paper? The insights can come form the results of the paper and form literature review Highlight 3-6 insights.
    ...
    'deeper': ''''What to learn to go deeper in this topic? What are the top 3-5 topics, the top 3 authors and the top 3 papers to read to go deeper in this topic?''',
}
