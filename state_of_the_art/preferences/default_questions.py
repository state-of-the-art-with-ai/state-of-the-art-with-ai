...
The insights can come form the results of the paper and form literature review Highlight 3-6 insights.
    ...
    "value_for_the_reader": "What is the most interesting value that would make the reader most satisfied after reading? Everybody gives their opinion. Which value would bring to the peole reaing it (do not be salesly)",
    "define_terms": """Which terms are the top 10 (at most) critical to understand the paper?
Prioritize mathematical terms definitons. Define them well with examples do not assume the reader knows them.
Use contrastive examples to make the definitions clear""",
