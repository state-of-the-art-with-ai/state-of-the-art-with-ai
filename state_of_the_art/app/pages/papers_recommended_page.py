...
history = RecommendationsHistoryTable().last()
recommendations = history.to_dict()
...
papers = sorted(papers, key=lambda x: papers_metadata[x.abstract_url]['labels'][0], reverse=True)
